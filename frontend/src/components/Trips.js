...
const Trips = () => {
  ...
  const fetchBookingsData = () => {
    const endpoints = [
      `http://localhost:5000/api/bookings/confirmed/${UserName}`,
      `http://localhost:5000/api/bookings/completed/${UserName}`,
      `http://localhost:5000/api/bookings/cancelled/${UserName}`
    ];
